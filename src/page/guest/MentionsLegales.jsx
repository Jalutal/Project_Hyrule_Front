    ...
    <body>
      <main>
        ...
        <div>
          ...
          <p>Nom : Jesse Granier</p>
          <p>Adresse du siège social : 1 rue de la plaine d'Hyrule, 33000 Hylia</p>
          <p>Téléphone : 0612457832</p>
          <p>Adresse e-mail : jesse.Granier@lapiscine.pro</p>
        </section>
        <section>
          <h2>Hébergeur</h2>
          <p>Nom : OVH</p>
        ...
        <section>
          ...
          <p>Chaque histoire publiée sur ce site est la propriété de son auteur.</p>
        </section>
        <section>
          <h2>Politique sur l'utilisation du contenu du site</h2>
          <p>Le contenu du site est utilisé uniquement dans le cadre de la création et du partage des fictions relatives au jeu-vidéo Zelda et exclusivement sur ce site.</p>
        </section>
        <section>
          <h2>Collecte et Traitement des Données Personnelles</h2>
          <p>Les données collectées sont le nom d'utilisateur et l'adresse e-mail de l'utilisateur. Ces informations sont stockées en base de données pour une durée de 3 ans, après quoi elles sont effacées.</p>
        </section>
        <section>
